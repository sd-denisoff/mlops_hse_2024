...
class ModelService(modelapi_pb2_grpc.ModelServiceServicer):
    def ListModels(self, request, context):
        return modelapi_pb2.ModelList(models={"linear": modelapi_pb2.ModelSpec(parameters=["coef_", "intercept_"]), "boosting": modelapi_pb2.ModelSpec(parameters=["learning_rate", "depth", "iterations"])})
