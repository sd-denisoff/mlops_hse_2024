...
`🏚 Главная` – общая информация о сервисе

`🏋️‍♀️ Обучение` – обучение модели с заданными гиперпараметрами

`🚀 Предсказания` – получение предсказаний выбранной модели

`📝 Управление` – управление списком моделей
